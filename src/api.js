...
function extractApiErrorMessage(data, fallback = 'Request failed') {
  ...
  if (preferred) {
    return extractApiErrorMessage(preferred, fallback);
  }
...
export const api = {
  ...
  divisions: (params) =>
    apiRequest('/divisions/', { params }),

  categories: (params) =>
    apiRequest('/product-categories/', { params }),

  loomBrands: (params) =>
    apiRequest('/loom-brands/', { params }),
  ...
  adminCategories: (params) =>
    apiRequest('/admin/product-categories/', { params }),

  adminLoomBrands: (params) =>
    apiRequest('/admin/loom-brands/', { params }),

  adminChemicalCategories: (params) =>
    apiRequest('/admin/loom-brands/', { params }),
  ...
  createCategory: (body) =>
    apiRequest('/admin/product-categories/', {
      method: 'POST',
      body,
    }),

  updateCategory: (id, body) =>
    apiRequest(`/admin/product-categories/${id}/`, {
      method: 'PUT',
      body,
    }),
  ...
  createLoomBrand: (body) =>
    apiRequest('/admin/loom-brands/', {
      method: 'POST',
      body,
    }),

  updateLoomBrand: (id, body) =>
    apiRequest(`/admin/loom-brands/${id}/`, {
      method: 'PUT',
      body,
    }),
  ...
  reorderProducts: (divisionId, productIds) =>
  ...
  deleteProductImage: (imageId, fileName) =>
    apiRequest(`/admin/product-images/${imageId}/`, {
      method: 'DELETE',
      body: {
        file_name: fileName,
      },
